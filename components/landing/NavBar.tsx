    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link
            href="/"
            className="flex items-center divide-x divide-primary/50"
          >
            ...
            <div className="pl-2">
              <div className="text-xl font-bold bg-linear-to-r from-secondary to-primary bg-clip-text text-transparent ">
                bubblab
              </div>
